        ...
        <div className="container mx-auto px-6 flex items-center justify-between max-w-[1400px]">
          <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
            <Link href="/" className="transition-transform duration-300 hover:scale-105">
              <img 
                src={!isTransparent && theme === 'light' ? "/images/Saydam zeminde orijinal_V2.webp" : "/images/Saydam zeminde orijinal_V4.webp"} 
                alt="LayersTech Logo" 
      ...
      {isOpen && (
        <div className="fixed inset-0 z-[60] bg-white dark:bg-[#1a1a1a] flex flex-col p-10 pt-24 xl:hidden animate-in slide-in-from-right duration-500 transition-colors">
          <div className="flex flex-col gap-6 relative z-50">
            ...
            <a href="tel:+902124656805" className={cn("flex items-center gap-3 text-lg font-bold mt-4 py-4", theme === 'light' ? "text-[#1a1a1a]" : "text-white")}>
